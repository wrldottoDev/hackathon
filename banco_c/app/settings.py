...
def _resolve_database_url() -> str:
    ...
    if explicit_url:
        return explicit_url
    raw_path = os.getenv("BANK_DB_PATH", "banco_c/app/banco_c.db")
    path = Path(raw_path)
...
BANK_ID = os.getenv("BANK_ID", "banco_c")
BANK_NAME = os.getenv("BANK_NAME", "Banco C")
BANK_CODE = os.getenv("BANK_CODE", "BKC")
DATABASE_URL = _resolve_database_url()
SECRET_KEY = os.getenv("BANK_SECRET_KEY", "banco-c-dev-secret-key-change-me-2026")
ALGORITHM = "HS256"
...
PUBLIC_API_URL = os.getenv(
    "BANK_PUBLIC_API_URL",
    BANK_REGISTRY.get(BANK_CODE, "http://127.0.0.1:8004"),
).rstrip("/")

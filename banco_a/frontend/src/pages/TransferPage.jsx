...
export default function TransferPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await apiRequest("/transactions/internal", {
        method: "POST",
  ...
  return (
    <>
      ...
      <p className="page-subtitle">Transfiere dinero entre cuentas del Banco A</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <input
                ...
                type="text"
                placeholder="BKA-XXXXXXXXXX"
                value={form.destination_account_number}
                onChange={handleChange}
                required
              />
              <span className="form-hint">Número de cuenta del destinatario (formato BKA-XXXXXXXXXX)</span>
            </div>

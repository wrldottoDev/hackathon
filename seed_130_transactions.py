...
━━━━━━━━━━━━━━━━━━━━━━━━
Genera 130 transacciones entre los bancos ligados a analytics (BKA y BKB)
con patrones variados que activan múltiples alertas de riesgo.

Requisitos previos:
  1. Banco A, Banco B y analytics deben estar corriendo:
...
def money(value: MoneyValue) -> str:
    return str(
        Decimal(str(value)).quantize(MONEY_QUANTUM, rounding=ROUND_HALF_UP)
    )
...
def block_internal_regular(client, sessions, counter):
    """20 transferencias internas rutinarias entre BKA y BKB."""
    print("\n[Bloque 1] 20 transferencias internas regulares")
    done = 0
    for bank_code in ["BKA", "BKB"]:
...
def block_burst_small(client, sessions, counter):
    ...
    burst_configs = [
        ...
        ("BKB", "pedro@bancob.com", "laura@bancob.com"),
    ]
...
def block_star_concentration(client, sessions, counter):
    ...
    star_configs = [
        ...
        (
            "BKB", "demo@bancob.com",
            "BKB", ["juan@bancob.com", "maria@bancob.com", "pedro@bancob.com", "laura@bancob.com", "jorge@bancob.com"],
        ),
    ]
...
def block_rapid_exit(client, sessions, counter):
    ...
    exit_configs = [
        ...
        ("BKB", "pedro@bancob.com", "demo@bancob.com", "laura@bancob.com"),
        ("BKA", "pablo@bancoa.com", "ana@bancoa.com", "carlos@bancoa.com"),
    ]
...
def block_interbank_chain(client, sessions, counter):
    """20 cadenas interbancarias A→B→A y B→A→B — activa RAPID_CHAIN."""
    print("\n[Bloque 6] 20 cadenas interbancarias (A↔B)")
    done = 0
    chains = [
        # (src_bank, src_email, mid_bank, mid_email, dst_bank, dst_email)
        ("BKA", "demo@bancoa.com", "BKB", "demo@bancob.com", "BKA", "ana@bancoa.com"),
        ("BKB", "demo@bancob.com", "BKA", "demo@bancoa.com", "BKB", "juan@bancob.com"),
    ]
    for _ in range(5):
...
def block_repeated_destination(client, sessions, counter):
    ...
    repeat_configs = [
        ...
        ("BKB", "pedro@bancob.com", "BKA", "ana@bancoa.com"),
    ]
...
def register_and_fetch(client: httpx.Client):
    """Registra BKA y BKB en analytics y ejecuta fetch."""
    headers = {"X-Analytics-Key": ANALYTICS_API_KEY}
    print("\n[Analytics] Registrando bancos BKA y BKB…")
...
def main():
    random.seed(42)
    print("=" * 60)
    print("FlowLens — seed de 130 transacciones A/B")
    print("=" * 60)

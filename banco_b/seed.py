...
USERS = [
    {
        "full_name": "Demo Cliente Banco B",
        "email": "demo@bancob.com",
        "balances": [50_000, 12_000],
    },
    {"full_name": "Mateo Rojas", "email": "mateo@bancob.com", "balances": [9_800]},
    {"full_name": "Valeria Lopez", "email": "valeria@bancob.com", "balances": [17_200]},
    {"full_name": "Jorge Jimenez", "email": "jorge@bancob.com", "balances": [8_600]},
    {"full_name": "Camila Solano", "email": "camila@bancob.com", "balances": [8_100]},
    {"full_name": "Daniel Mora", "email": "daniel@bancob.com", "balances": [7_950]},
]
...
def seed_bank():
    ...
    with SessionLocal() as db:
        ...
        demo_user, demo_accounts = created_users["demo@bancob.com"]
        ana_user, ana_accounts = created_users["mateo@bancob.com"]
        carlos_user, carlos_accounts = created_users["valeria@bancob.com"]
        luisa_user, luisa_accounts = created_users["jorge@bancob.com"]
        pablo_user, pablo_accounts = created_users["camila@bancob.com"]
        sofia_user, sofia_accounts = created_users["daniel@bancob.com"]
